...
Begin VB.Form FormProsesStock 
   ...
   Begin TrueOleDBGrid80.TDBGrid TDBGrid2 
      ...
      Splits(0)._ColumnProps(14)=   "Column(3).Width=4789"
      Splits(0)._ColumnProps(15)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(16)=   "Column(3)._WidthInPix=4710"
      ...
      _StyleDefs(58)  =   "Splits(0).Columns(7).Style:id=66,.parent=11"
      _StyleDefs(59)  =   "Splits(0).Columns(7).HeadingStyle:id=63,.parent=12"
      _StyleDefs(60)  =   "Splits(0).Columns(7).FooterStyle:id=64,.parent=13"
      _StyleDefs(61)  =   "Splits(0).Columns(7).EditorStyle:id=65,.parent=15"
      ...
      _StyleDefs(79)  =   "Named:id=39:RecordSelector"
      _StyleDefs(80)  =   ":id=39,.parent=30"
      _StyleDefs(81)  =   "Named:id=42:FilterBar"
      _StyleDefs(82)  =   ":id=42,.parent=29"
   End
   ...
   Begin TrueOleDBGrid80.TDBGrid TDBGrid1 
      ...
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "IdtOut"
      Columns(5).DataField=   ""
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(6)._VlistStyle=   0
      Columns(6)._MaxComboItems=   5
      Columns(6).Caption=   "HPPClue"
      Columns(6).DataField=   ""
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   0
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "FromNPB"
      Columns(7).DataField=   ""
      Columns(7)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(8)._VlistStyle=   0
      Columns(8)._MaxComboItems=   5
      Columns(8).Caption=   "QTYAll"
      Columns(8).DataField=   ""
      ...
      Splits(0)._ColumnProps(19)=   "Column(4).Width=6112"
      Splits(0)._ColumnProps(20)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(21)=   "Column(4)._WidthInPix=6033"
      Splits(0)._ColumnProps(22)=   "Column(4).Order=5"
      ...
      Splits(0)._ColumnProps(26)=   "Column(5)._WidthInPix=2646"
      Splits(0)._ColumnProps(27)=   "Column(5).Order=6"
      Splits(0)._ColumnProps(28)=   "Column(5)._MinWidth=-2147483642"
      ...
      _StyleDefs(54)  =   "Splits(0).Columns(6).Style:id=62,.parent=11"
      _StyleDefs(55)  =   "Splits(0).Columns(6).HeadingStyle:id=59,.parent=12"
      _StyleDefs(56)  =   "Splits(0).Columns(6).FooterStyle:id=60,.parent=13"
      _StyleDefs(57)  =   "Splits(0).Columns(6).EditorStyle:id=61,.parent=15"
      _StyleDefs(58)  =   "Splits(0).Columns(7).Style:id=70,.parent=11"
      _StyleDefs(59)  =   "Splits(0).Columns(7).HeadingStyle:id=67,.parent=12"
      _StyleDefs(60)  =   "Splits(0).Columns(7).FooterStyle:id=68,.parent=13"
      _StyleDefs(61)  =   "Splits(0).Columns(7).EditorStyle:id=69,.parent=15"
      _StyleDefs(62)  =   "Splits(0).Columns(8).Style:id=74,.parent=11"
      _StyleDefs(63)  =   "Splits(0).Columns(8).HeadingStyle:id=71,.parent=12"
      _StyleDefs(64)  =   "Splits(0).Columns(8).FooterStyle:id=72,.parent=13"
      _StyleDefs(65)  =   "Splits(0).Columns(8).EditorStyle:id=73,.parent=15"
      ...
      _StyleDefs(83)  =   "Named:id=39:RecordSelector"
      _StyleDefs(84)  =   ":id=39,.parent=30"
      _StyleDefs(85)  =   "Named:id=42:FilterBar"
      _StyleDefs(86)  =   ":id=42,.parent=29"
   End
...
On Error Resume Next
    ...
    a = "select t_In.Dept, NoBukti, Tanggal, t_In.IdStock, NamaBarang, QTY, Satuan, Keterangan, StatusPindahStock, TanggalOK, StatusOut, IdtOut, HPPClue, FromNPB, QTYAll from t_In left join m_StockBeli on t_In.IdStock=m_StockBeli.IdStock where NoBukti='" & esc(tNo) & "'"
    query a
    If RS.RecordCount < 1 Then Exit Sub
    fDari.ListIndex = fDari.FindIndex(RS.Fields("Dept").Value)
    fNo = RS.Fields("NoBukti").Value
    fTanggal = cTanggal(RS.Fields("Tanggal").Value)
    fTanggalOK = cTanggal(RS.Fields("TanggalOK").Value)
    fOK.Visible = RS.Fields("StatusPindahStock").Value = 0 And cD(fTanggalOK) <> "A"
    fBatal.Visible = Not fOK.Visible And cD(fTanggalOK) <> "A"
    ...
    For i = 0 To x1.UpperBound(1)
        ...
        x1(i, 5) = RS.Fields("IdtOut").Value
        x1(i, 6) = RS.Fields("HPPClue").Value
        x1(i, 7) = RS.Fields("FromNPB").Value
        x1(i, 8) = RS.Fields("QTYAll").Value
        RS.MoveNext
    Next
    TDBGrid1.Rebind
    a = "select KdDept, t_Out.Dept, t_Out.IdStock, NamaBarang, QTY, Satuan, Keterangan, StatusOK, StatusPindahStock, TanggalOK, StockWaste from (t_Out left join m_departemen on t_Out.Dept=m_departemen.Departemen) left join m_stockBeli on m_stockBeli.IdStock=t_Out.IdStock where NoBukti='" & esc(tNo) & "'"
    query a
    If RS.RecordCount < 1 Then Exit Sub
    fOK.Visible = False
    fBatal.Visible = False
    ...
    For i = 0 To x2.UpperBound(1)
        ...
        x2(i, 7) = RS.Fields("StockWaste").Value
        RS.MoveNext
    Next
    TDBGrid2.Rebind
End Sub

Private Sub fNo_Validate(Cancel As Boolean)
On Error Resume Next
    fNo = zerofill(CLng(Left(fNo, 5)), 5) & "/" & zerofill(fDari.ItemData(fDari.ListIndex), 2) & Right(fTanggal, 3)
End Sub
...
Sub SetOtherRowData(ByVal tId As Long)
    TDBGrid2.SetFocus
    a = "Select top 1 m_StockProses.IdStock, NamaBarang, Satuan, StockWaste from m_StockProses left join m_StockBeli on m_StockProses.IdStock=m_StockBeli.IdStock where m_StockProses.IdStock=" & tId & " and m_StockProses.Dept='" & esc(col2("Departemen").Value) & "'"
    query a
    If RS.RecordCount > 0 Then
        ...
        col2("StockWaste").Value = RS.Fields("StockWaste").Value
    Else
        col2("IdStock").Value = ""
        col2("Nama Barang").Value = ""
        col2("Satuan").Value = ""
        col2("StockWaste").Value = ""
    End If
End Sub
...
Dim MaxNoBukti As String
    If fDari.ListIndex = -1 Or Not fDari.Enabled Then
        Exit Sub
    End If
    a = "select max(NoBukti) from t_In where Tanggal>" & pAddNoLong & " and Dept='" & esc(fDari) & "'"
    query a
    MaxNoBukti = IIf(IsNull(RS.Fields(0).Value), 1, Left(RS.Fields(0).Value, 5) + 1)
    fNo = zerofill(MaxNoBukti, 5) & "/" & zerofill(fDari.ItemData(fDari.ListIndex), 2) & pAddNo
    iToolbar1.SetQuick fNo
    a = "select t_Out.IdStock, NamaBarang, t_Out.QTY-t_Out.Terpakai, Satuan, Keterangan, IdtOut, HPPClue, FromNPB, QTY from t_Out left join m_StockBeli on m_StockBeli.IdStock=t_Out.IdStock where Dept='" & esc(fDari) & "' and t_Out.QTY>t_Out.Terpakai and StatusPindahStock=1"
    query a
...
Private Sub Form_Load()
    ...
    col1("QTY").Tag = "Decimal"
    TDBGridSetLock TDBGrid1, "IdStock@Nama Barang@Satuan", True
    'TDBGridSetVisible TDBGrid1, "IdtOut@HPPClue@Terpakai"
    TDBGridLoad TDBGrid1
    
    col2("Kode").AutoDropDown = True
    col2("Kode").DropDown = TDBDropDown1
    col2("QTY").Tag = "Decimal"
    TDBGridSetLock TDBGrid2, "Nama Barang@Departemen@Satuan", True
    ...
    iToolbar1.SetVisible "PRINT"
    iToolbar1_NewClick
End Sub

Private Sub Form_Resize()
On Error Resume Next
    iToolbar1.Width = ScaleWidth - iToolbar1.Left - 100
...
On Error GoTo err
    BeginTransaction
    a = "delete from t_In where NoBukti='" & esc(fNo) & "'"
    ExecMe a
    a = "delete from t_Out where NoBukti='" & esc(fNo) & "'"
    ExecMe a
    For i = 0 To x1.UpperBound(1)
        ...
        ExecMe a
        a = "update m_StockProses set JumlahTerpakai=JumlahTerpakai-" & cNum(x1(i, col1("QTY").ColIndex)) & " where IdStock=" & x1(i, col1("IdStock").ColIndex) & " and Dept='" & esc(fDari) & "'"
        ExecMe a
        a = "update t_Out set Terpakai=Terpakai-" & cNum(x1(i, col1("QTY").ColIndex)) & " where IdtOut=" & x1(i, col1("IdtOut").ColIndex)
        If ExecMe(a) = 0 Then GoTo err
        a = "select top 1 IdtOut from t_In where IdtOut=" & x1(i, col1("IdtOut").ColIndex)
        query a
        If RS.RecordCount > 0 Then
            MsgBox "Sudah ada di Nota Input"
            GoTo err
        End If
    Next
    CommitTransaction
...
On Error Resume Next
    ...
    ReDim TempIdStock(x1.UpperBound(1))
    ReDim TempIdtOut(x1.UpperBound(1))
    For i = 0 To x1.UpperBound(1)
        TempIdStock(i) = x1(i, col1("IdStock").ColIndex)
        TempQTY(i) = x1(i, col1("QTY").ColIndex)
        TempIdtOut(i) = x1(i, col1("IdtOut").ColIndex)
    Next
End Sub
...
On Error GoTo err
    ...
    TDBGrid2.Update
    If m_mode <> "NEW" Then
        a = "delete from t_In where NoBukti='" & esc(TempNoBukti) & "'"
        ExecMe a
        a = "delete from t_Out where NoBukti='" & esc(TempNoBukti) & "'"
        ExecMe a
    End If
    If m_mode = "EDIT" Then
        For i = 0 To UBound(TempQTY)
            a = "update m_StockProses set JumlahTerpakai=JumlahTerpakai-" & cNum(TempQTY(i)) & " where IdStock=" & TempIdStock(i) & " and Dept='" & esc(fDari) & "'"
            If ExecMe(a) = 0 Then GoTo err
            a = "update t_Out set Terpakai=Terpakai-" & cNum(TempQTY(i)) & " where IdtOut=" & TempIdtOut(i)
            If ExecMe(a) = 0 Then GoTo err
        Next
    End If
    Dim HPPClueGabungan As String
    HPPClueGabungan = ""
    For i = 0 To x1.UpperBound(1)
        If x1(i, col1("QTY").ColIndex) <> 0 Then
            a = "insert into t_In(NoBukti,Tanggal,IdStock,QTY,Keterangan,Dept, StatusOut, TanggalOK, IdtOut, HPPClue, FromNPB, QTYAll) values('" & _
                fNo & _
                "'," & cD(fTanggal) & _
                "," & x1(i, col1("IdStock").ColIndex) & _
                "," & cNum(x1(i, col1("QTY").ColIndex)) & _
                ",'" & x1(i, col1("Keterangan").ColIndex) & _
                "','" & fDari & _
                "'," & IIf(cD(fTanggalOK) = "A", 0, 1) & _
                "," & cD(fTanggalOK) & _
                "," & x1(i, col1("IdtOut").ColIndex) & _
                ",'" & x1(i, col1("HPPClue").ColIndex) & _
                "'," & x1(i, col1("FromNPB").ColIndex) & _
                "," & cNum(x1(i, col1("QTYAll").ColIndex)) & ")"
            If ExecMe(a) = 0 Then GoTo err
            persen = ""
            If x1(i, col1("QTY").ColIndex) / x1(i, col1("QTYAll").ColIndex) < 1 Then
                persen = cNum(x1(i, col1("QTY").ColIndex)) & "/" & cNum(x1(i, col1("QTYAll").ColIndex)) & "*"
            End If
            If x1(i, col1("FromNPB").ColIndex) > 0 Then HPPClueGabungan = HPPClueGabungan & "+" & persen & "@" & x1(i, col1("IdtOut").ColIndex) & "@"
            If Not IsNull(x1(i, col1("HPPClue").ColIndex)) And x1(i, col1("HPPClue").ColIndex) <> "" Then
                c = x1(i, col1("HPPClue").ColIndex)
                If persen = "" Then
                    HPPClueGabungan = HPPClueGabungan & "+" & c
                ElseIf InStrRev(c, "@", InStrRev(c, "@") - 1) = 1 Then
                    HPPClueGabungan = HPPClueGabungan & "+" & persen & c
                Else
                    HPPClueGabungan = HPPClueGabungan & "+" & persen & "(" & c & ")"
                End If
            End If
        ...
        End If
    Next
    HPPClueGabungan = Mid(HPPClueGabungan, 2)
    Dim TotalKG As Double
    For i = 0 To x2.UpperBound(1)
        TotalKG = TotalKG + (1 - x2(i, col2("StockWaste").ColIndex)) * x2(i, col2("QTY").ColIndex)
    Next
    Dim HPPClue As String
    For i = 0 To x2.UpperBound(1)
        HPPClue = ""
        If x2(i, col2("StockWaste").ColIndex) = 0 Then
            If x2(i, col2("QTY").ColIndex) / TotalKG < 1 Then
                If InStrRev(HPPClueGabungan, "@", InStrRev(HPPClueGabungan, "@") - 1) = 1 Then
                    HPPClue = cNum(x2(i, col2("QTY").ColIndex)) & "/" & cNum(TotalKG) & "*" & HPPClueGabungan
                Else
                    HPPClue = cNum(x2(i, col2("QTY").ColIndex)) & "/" & cNum(TotalKG) & "*(" & HPPClueGabungan & ")"
                End If
            Else
                HPPClue = HPPClueGabungan
            End If
        End If
        a = "insert into t_Out(NoBukti,Tanggal,IdStock,QTY,Keterangan,Dept,StatusOK,TanggalOK,DeptAsal,HPPClue) values('" & _
            fNo & _
            "'," & cD(fTanggal) & _
            "," & x2(i, col2("IdStock").ColIndex) & _
            "," & cNum(x2(i, col2("QTY").ColIndex)) & _
...
On Error Resume Next
    a = "select min(NoBukti) from t_In where left(NoBukti,5)='" & esc(Left(iToolbar1.GetText, 5)) & "'"
    query a
