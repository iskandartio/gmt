Public Class frmtInputStock
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        For Each row As DataGridViewRow In dgDetail.Rows
            ...
            row.Cells("Kg").Value = Math.Round(row.Cells("Kg").Value, 2)
            tTotalKG = tTotalKG + row.Cells("Kg").Value
            tTotalCones = tTotalCones + row.Cells("Cns").Value
            tTotal = tTotal + 1
        Next
        bs.EndEdit()
        If Not (dbLot.Text = "" OrElse dbLot.Text = dbNoWarna.Text OrElse a.check_lot(dbLot.Text, dbKodeBarang.Text, dbWarna.Text)) Then
            MsgBox("Lot Salah atau Kode Barang salah")
            Exit Sub
        End If
    ...
    Private Sub bs_CurrentChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles bs.CurrentChanged
        Try
            ...
            txtNoUrut.Text = a.qNextNoUrut(mdt.Rows(bs.Position)("KodeBarang").ToString, mdt.Rows(bs.Position)("Warna").ToString, mdt.Rows(bs.Position)("NoWarna").ToString, Year(dtTgl.Value) - 2000)
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        a.Printed()
        Search()
        Dim b As New rptInputStock
        b.LoadMe(dtPrint)
    End Sub

    Private Sub txtKg_PreviewKeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.PreviewKeyDownEventArgs) Handles txtKg.PreviewKeyDown
        e.IsInputKey = False
    End Sub

    Private Sub txtKg_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtKg.Enter
        txtNoUrut.Text = a.qNextNoUrut(dbKodeBarang.Text, dbWarna.Text, dbNoWarna.Text, Year(dtTgl.Value) - 2000)
    End Sub
