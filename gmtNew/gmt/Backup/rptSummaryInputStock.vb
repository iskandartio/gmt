Public Class rptSummaryInputStock
    ...
    Private Sub prt_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles prt.PrintPage
        ...
        PrintFooter(e, urut, 0, y, BoxCount, KgCount)
        dTotal.Text = "GRAND TOTAL"
        PrintFooter(e, urut, 0, y + 50, GrandBoxCount, GrandKgCount)
    ...
    Public Sub GetPosition(ByRef c As Control, ByRef f As StringFormat, ByRef l As Single)
        ...
        End If
    End Sub
    Private Sub PrintFooter(ByVal e As System.Drawing.Printing.PrintPageEventArgs, ByVal urut As Integer, ByVal xHeader As Single, ByVal y As Single, ByVal tBoxCount As Integer, ByVal tKgCount As Double)
        Dim i As Integer
        ...
        For Each c As Control In GroupFooter.Controls
            If c.Text = "BoxCount" Then
                DrawMe(c, dtPrint.Rows(0), e, 0, y - 15, tBoxCount)
            ElseIf c.Text = "KgCount" Then
                DrawMe(c, dtPrint.Rows(0), e, 0, y - 15, Format(tKgCount, "#,##0.00"))
            Else
