...
Begin VB.Form FormSettingAccounting 
   BackColor       =   &H00FFC0C0&   Caption         =   "SETTING ACCOUNTING"
   ClientHeight    =   6135
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11055
   ...
   Begin VB.CommandButton fSetting 
      Caption         =   "NERACA DAN RL SETTING"
      Height          =   375
      Left            =   5040
      TabIndex        =   6
      Top             =   1560
   ...
   Begin VB.TextBox Text1 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   2
      Text            =   "FormSettingAccounting.frx":0000
      Top             =   0
      Width           =   10815
   End
   Begin TrueOleDBGrid80.TDBDropDown TDBDropDown1 
      ...
      Splits(0)._ColumnProps(11)=   "Column(1)._MinWidth=165247296"
      Splits.Count    =   1
   ...
   Begin TrueOleDBGrid80.TDBGrid TDBGrid1 
      ...
      Columns(0)._VlistStyle=   0
      Columns(0)._MaxComboItems=   5
      Columns(0).Caption=   "Nama Setting"
      Columns(0).DataField=   ""
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "No Acc"
      Columns(1).DataField=   ""
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "Ket Acc"
      Columns(2).DataField=   ""
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "SQL Summary"
      Columns(3).DataField=   ""
      Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(4)._VlistStyle=   0
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "SQL Detail"
      Columns(4).DataField=   ""
      ...
      Splits(0)._ColumnProps(15)=   "Column(2)._MinWidth=165224192"
      Splits(0)._ColumnProps(16)=   "Column(3).Width=3281"
      Splits(0)._ColumnProps(17)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(18)=   "Column(3)._WidthInPix=3201"
      Splits(0)._ColumnProps(19)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(20)=   "Column(3)._MinWidth=165224192"
      Splits(0)._ColumnProps(21)=   "Column(4).Width=8599"
      Splits(0)._ColumnProps(22)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(23)=   "Column(4)._WidthInPix=8520"
      Splits(0)._ColumnProps(24)=   "Column(4).Order=5"
      Splits(0)._ColumnProps(25)=   "Column(4)._MinWidth=165224192"
      Splits.Count    =   1
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Insert ke Tabel dengan Double Click atau tekan F4"
      Height          =   255
      Left            =   0
      TabIndex        =   3
      Top             =   1560
   ...
   End
End
Attribute VB_Name = "FormSettingAccounting"
...
Private Sub Form_Load()
    ...
    col1("Nama Setting").Locked = True
    DoQuery
End Sub

Private Sub DoQuery()
    a = "select NamaSetting, NoAcc, KetAcc, SQLSummary, SQLDetail from m_SettingAccounting order by NamaSetting"
    query a
...
On Error GoTo err
    ...
    For i = 0 To x.UpperBound(1)
        a = "update m_SettingAccounting set " & _
            "NoAcc='" & x(i, col1("No Acc").ColIndex) & "" & _
            "', KetAcc='" & x(i, col1("Ket Acc").ColIndex) & "" & _
            "', SQLSummary='" & esc(x(i, col1("SQL Summary").ColIndex) & "") & _
            "', SQLDetail='" & esc(x(i, col1("SQL Detail").ColIndex) & "") & "' where NamaSetting='" & esc(x(i, col1("Nama Setting").ColIndex)) & "'"
        CN.Execute a, b
        If b = 0 Then GoTo err
    Next
    CN.CommitTrans
    MsgBox "SUKSES"
    DoQuery
