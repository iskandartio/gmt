Public Class db
    ...
    Public Function doQuery(ByVal tSQL As String, Optional ByVal arr As ArrayList = Nothing, Optional ByVal tReadonly As Boolean = False, Optional ByVal tSetDefault As Boolean = False) As DataTable
    ...
    Public Function doQueryReader(ByVal tSQL As String, Optional ByVal arr As ArrayList = Nothing, Optional ByVal tReadonly As Boolean = False) As IDataReader
        ...
        Return rdr
    End Function
    Public Function doQueryScalar(ByVal tSQL As String, Optional ByVal arr As ArrayList = Nothing, Optional ByVal tReadonly As Boolean = False) As Object
        Dim rdr As IDataReader
        If conn.State = ConnectionState.Closed Then ConnectDB()
        cmd.Parameters.Clear()
        If Not arr Is Nothing Then
    ...
    Private Sub setDefault(ByRef dt As DataTable, ByVal tReadOnly As Boolean)
        ...
        For i As Integer = 0 To col.Count - 1
            ...
            ElseIf tType = "String" Then
                col(i).DefaultValue = ""
            ElseIf Left(tType, 3) = "Int" OrElse tType = "Double" OrElse tType = "Decimal" Then
    ...
    Public Function doQuery2(ByVal tSQL As String, Optional ByVal arr As ArrayList = Nothing, Optional ByVal tReadonly As Boolean = False) As List(Of DataTable)
    ...
    Public Function execMe(ByVal tSQL As String, Optional ByVal arr As ArrayList = Nothing, Optional ByVal tReturnID As Boolean = False) As Integer
        If conn.State = ConnectionState.Closed Then ConnectDB()
        cmd.Parameters.Clear()
        If Not arr Is Nothing Then
            For Each a As Param In arr
    ...
    Public Sub New(Optional ByVal s As String = "")
        ...
        If s = "" Then s = [GetType].Namespace
        s2 = System.Configuration.ConfigurationManager.ConnectionStrings([GetType].Namespace & ".My.MySettings." & s & "ConnectionString").ConnectionString
        i = s2.IndexOf("Password=")
        i2 = s2.IndexOf(";Connect", i)
