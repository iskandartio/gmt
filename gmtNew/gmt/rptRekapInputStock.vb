    ...
    Private Sub prt_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles prt.PrintPage
        ...
        For i As Integer = mCurrent To dtPrint.Rows.Count - 1
            ...
            If y > 1050 Then
                ...
                If i = dtPrint.Rows.Count - 1 OrElse Last <> dtPrint.Rows(i + 1)("KodeBarang") & "!@#" & dtPrint.Rows(i + 1)("Lot") Then
                    PrintFooter(e, urut, 0, y, ConesCount, BoxCount, KgCount)
                    y = y + 40
                    urut = 0
                    x = 0
                    ...
                    BoxCount = 0
                    KgCount = 0
                    If i <> dtPrint.Rows.Count - 1 Then
                        Last = dtPrint.Rows(i + 1)("KodeBarang") & "!@#" & dtPrint.Rows(i + 1)("Lot")
                    End If
