Public Class frmtInputStock
    ...
    Private Sub bs_CurrentChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles bs.CurrentChanged
        Try
            ...
            txtNoUrut.Text = a.qNextNoUrut(mdt.Rows(bs.Position)("KodeBarang").ToString, mdt.Rows(bs.Position)("Warna").ToString, mdt.Rows(bs.Position)("NoWarna").ToString)
    ...
    Private Sub txtKg_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtKg.Enter
        txtNoUrut.Text = a.qNextNoUrut(dbKodeBarang.Text, dbWarna.Text, dbNoWarna.Text)
    End Sub
End Class
