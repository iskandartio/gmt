...
Begin VB.Form FormPelunasanPembelian 
   BackColor       =   &H00FFC0C0&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TrueOleDBGrid80.TDBGrid TDBGrid2 
         ...
         Columns(2)._VlistStyle=   0
         Columns(2)._MaxComboItems=   5
         Columns(2).Caption=   "No Ref"
         Columns(2).DataField=   ""
         Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(3)._VlistStyle=   0
         Columns(3)._MaxComboItems=   5
         Columns(3).Caption=   "Nilai Faktur"
         Columns(3).DataField=   ""
         Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(4)._VlistStyle=   0
         Columns(4)._MaxComboItems=   5
         Columns(4).Caption=   "Lunas"
         Columns(4).DataField=   ""
         Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(5)._VlistStyle=   0
         Columns(5)._MaxComboItems=   5
         Columns(5).Caption=   "Sisa"
         Columns(5).DataField=   ""
         Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(6)._VlistStyle=   0
         Columns(6)._MaxComboItems=   5
         Columns(6).Caption=   "Bayar"
         Columns(6).DataField=   ""
         Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(7)._VlistStyle=   0
         Columns(7)._MaxComboItems=   5
         Columns(7).Caption=   "Bayar RP"
         Columns(7).DataField=   ""
         Columns(7)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(8)._VlistStyle=   0
         Columns(8)._MaxComboItems=   5
         ...
         Splits(0)._ColumnProps(14)=   "Column(2)._ColStyle=532"
         Splits(0)._ColumnProps(15)=   "Column(2).Order=3"
         Splits(0)._ColumnProps(16)=   "Column(3).Width=2778"
         Splits(0)._ColumnProps(17)=   "Column(3).DividerColor=0"
         Splits(0)._ColumnProps(18)=   "Column(3)._WidthInPix=2699"
         ...
         Splits(0)._ColumnProps(29)=   "Column(5)._ColStyle=8724"
         Splits(0)._ColumnProps(30)=   "Column(5).Order=6"
         Splits(0)._ColumnProps(31)=   "Column(6).Width=2328"
         Splits(0)._ColumnProps(32)=   "Column(6).DividerColor=0"
         Splits(0)._ColumnProps(33)=   "Column(6)._WidthInPix=2249"
         Splits(0)._ColumnProps(34)=   "Column(6)._ColStyle=532"
         Splits(0)._ColumnProps(35)=   "Column(6).Order=7"
         ...
         _StyleDefs(44)  =   "Splits(0).Columns(3).Style:id=40,.parent=11,.alignment=3,.locked=-1"
         _StyleDefs(45)  =   "Splits(0).Columns(3).HeadingStyle:id=37,.parent=12,.alignment=2"
         _StyleDefs(46)  =   "Splits(0).Columns(3).FooterStyle:id=38,.parent=13,.alignment=3"
         _StyleDefs(47)  =   "Splits(0).Columns(3).EditorStyle:id=39,.parent=15"
         _StyleDefs(48)  =   "Splits(0).Columns(4).Style:id=44,.parent=11,.alignment=3,.locked=-1"
         _StyleDefs(49)  =   "Splits(0).Columns(4).HeadingStyle:id=41,.parent=12,.alignment=2"
         _StyleDefs(50)  =   "Splits(0).Columns(4).FooterStyle:id=42,.parent=13,.alignment=3"
         _StyleDefs(51)  =   "Splits(0).Columns(4).EditorStyle:id=43,.parent=15"
         _StyleDefs(52)  =   "Splits(0).Columns(5).Style:id=60,.parent=11,.alignment=3,.locked=-1"
         _StyleDefs(53)  =   "Splits(0).Columns(5).HeadingStyle:id=57,.parent=12,.alignment=2"
         _StyleDefs(54)  =   "Splits(0).Columns(5).FooterStyle:id=58,.parent=13,.alignment=3"
         _StyleDefs(55)  =   "Splits(0).Columns(5).EditorStyle:id=59,.parent=15"
         _StyleDefs(56)  =   "Splits(0).Columns(6).Style:id=64,.parent=11,.bgcolor=&HFFFDDF&"
         _StyleDefs(57)  =   "Splits(0).Columns(6).HeadingStyle:id=61,.parent=12"
         _StyleDefs(58)  =   "Splits(0).Columns(6).FooterStyle:id=62,.parent=13"
         _StyleDefs(59)  =   "Splits(0).Columns(6).EditorStyle:id=63,.parent=15"
         _StyleDefs(60)  =   "Splits(0).Columns(7).Style:id=28,.parent=11"
         _StyleDefs(61)  =   "Splits(0).Columns(7).HeadingStyle:id=25,.parent=12"
         _StyleDefs(62)  =   "Splits(0).Columns(7).FooterStyle:id=26,.parent=13"
         _StyleDefs(63)  =   "Splits(0).Columns(7).EditorStyle:id=27,.parent=15"
         _StyleDefs(64)  =   "Splits(0).Columns(8).Style:id=68,.parent=11"
         _StyleDefs(65)  =   "Splits(0).Columns(8).HeadingStyle:id=65,.parent=12"
         _StyleDefs(66)  =   "Splits(0).Columns(8).FooterStyle:id=66,.parent=13"
         _StyleDefs(67)  =   "Splits(0).Columns(8).EditorStyle:id=67,.parent=15"
         _StyleDefs(68)  =   "Splits(0).Columns(9).Style:id=80,.parent=11"
         _StyleDefs(69)  =   "Splits(0).Columns(9).HeadingStyle:id=77,.parent=12"
         _StyleDefs(70)  =   "Splits(0).Columns(9).FooterStyle:id=78,.parent=13"
         _StyleDefs(71)  =   "Splits(0).Columns(9).EditorStyle:id=79,.parent=15"
         _StyleDefs(72)  =   "Named:id=29:Normal"
         _StyleDefs(73)  =   ":id=29,.parent=0,.valignment=2"
         _StyleDefs(74)  =   "Named:id=30:Heading"
         _StyleDefs(75)  =   ":id=30,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
         ...
         _StyleDefs(87)  =   "Named:id=36:OddRow"
         _StyleDefs(88)  =   ":id=36,.parent=29"
         _StyleDefs(89)  =   "Named:id=83:RecordSelector"
         _StyleDefs(90)  =   ":id=83,.parent=30"
         _StyleDefs(91)  =   "Named:id=86:FilterBar"
         _StyleDefs(92)  =   ":id=86,.parent=29"
      End
   ...
   End
End
Attribute VB_Name = "FormPelunasanPembelian"
...
On Error Resume Next
    ...
    End If
    a = "select max(NoSTT) from t_PembelianSTT where Tanggal>=" & b & " and Tanggal <= " & b + 10000
    query a
...
Private Sub fSupplier_KeyDown(KeyCode As Integer, Shift As Integer)
    If Not LSupplier Then
        a = "select distinct NamaSupplier, t_BTB.MataUang from t_BTB where Total>Pelunasan order by NamaSupplier"
        query a
Dim rs1() As Variant
        rs1 = RS.GetRows
        fSupplier.SetDB rs1
...
Private Sub fSupplier_LostFocus()
On Error GoTo err
    If Not fSupplier.Enabled Then Exit Sub
    If fSupplier.GetData("Nama Supplier") = "" Then Exit Sub
    fMataUang = fSupplier.GetData("Mata Uang")
    a = "select NoBTB, TanggalBTB, NoRef, Total, Pelunasan, Total-Pelunasan, 0, '', '', MataUang from t_BTB where Pelunasan-Total<0 and t_BTB.NamaSupplier='" & fSupplier & "' and MataUang='" & fMataUang & "' order by TanggalBTB, NoBTB"
    query a
    x(1).ReDim 0, 0, 0, TDBGrid2.Columns.Count - 1
    x(1).DeleteRows 0
    If RS.RecordCount > 0 Then x(1).LoadRows RS.GetRows
    TDBGrid2.Rebind
    a = "select NoNR, TanggalNR, Total, Potong, Total-Potong, 0, '','' from t_NRPembelian where Total-Potong>0 and t_NRPembelian.NamaSupplier='" & fSupplier & "' and MataUang='" & fMataUang & "' order by NoNR"
    query a
...
Private Sub fList_Click()
    FormList.LoadMe _
        "STT Belum Cair@STT Lunas", "select NoSTT,Tanggal,Debet,Kredit,Pembulatan,NamaSupplier from t_PembelianSTT where GiroNum>0@" & _
        "select NoSTT,Tanggal,Debet,Kredit,Pembulatan,NamaSupplier from t_PembelianSTT where GiroNum=0", _
        "No STT@TANGGAL@Supplier@MATA UANG", "NoSTT@TANGGAL@NamaSupplier@MataUang", "1000@1000@2000@700", "String@Date@StringLike@String", _
        "No STT@TANGGAL@DEBET@KREDIT@PEMBULATAN@Supplier", _
...
On Error Resume Next
    fKurs = ""
    fKurs.Tag = ""
    a = "select top 1 NoSTT,Tanggal,NamaSupplier, MataUang from t_PembelianSTT where NoSTT='" & esc(tNo) & "'"
    query a
    ...
    a = "select CaraBayar,NamaBank,NoGiro, TanggalGiro, Nilai, NilaiRP, DebetAcc, KetAcc, Keterangan from t_PembelianSTTPembayaran where NoSTT='" & esc(tNo) & "' order by TanggalGiro"
    query a
    ...
    End If
    TDBGrid1.Rebind
    a = "select NoFaktur, TanggalFaktur, NoRef, NilaiFaktur, Lunas, Sisa, Nilai, NilaiRP, Keterangan, MataUang from t_PembelianSTTPelunasan where NoSTT='" & esc(tNo) & "'"
    query a
    x(1).ReDim 0, 0, 0, TDBGrid2.Columns.Count - 1
    x(1).DeleteRows 0
    If RS.RecordCount > 0 Then x(1).LoadRows RS.GetRows
    TDBGrid2.Rebind
    a = "select NoBukti,TanggalBukti,NilaiRetur, Terpotong, Sisa, Nilai,NilaiRP, Keterangan from t_PembelianSTTPotongan where NoSTT='" & esc(tNo) & "'"
    query a
    x(2).ReDim 0, 0, 0, TDBGrid3.Columns.Count - 1
    x(2).DeleteRows 0
    If RS.RecordCount > 0 Then x(2).LoadRows RS.GetRows
...
On Error Resume Next
    ClearScreen
    a = "select max(NoSTT) from t_PembelianSTT where Tanggal>" & pAddNoLong
    query a
    If Not IsNull(RS.Fields(0).Value) Then
...
Private Sub Form_Load()
    ...
    'col3("Mata Uang").Visible = False
    
    fSupplier.SetHeader "Nama Supplier@Mata Uang"
    fSupplier.SetWidth "3000@1500"
    fSupplier.SetType "String@String"
    
End Sub

Private Sub fPrint_Click()
    'FormReport.LoadMe "PembelianSTTPenjualan.rpt", fNoSTT
End Sub
...
Dim TglIndex() As Long
    ...
    For i = 0 To x(0).UpperBound(1)
        ...
        Tgl(m) = Tgl(i)
    Next
Dim TglPelunasan() As Long
Dim StatusLunas() As Byte
Dim NoGiro() As String
    ReDim TglPelunasan(x(1).UpperBound(1))
    ReDim StatusLunas(x(1).UpperBound(1))
    ReDim NoGiro(x(1).UpperBound(1))
    'Kalkulasi Pelunasan Per Surat Jalan
    'Kurangin Retur Dulu
    i = 0
    If x(2).UpperBound(1) >= 0 Then
        j = 0
        i = 0
        n = CDbl(x(2)(j, col3("Nilai").ColIndex))
        m = CDbl(x(0)(TglIndex(i), col1("Nilai").ColIndex))
        Do
            If n <= m Then
                j = j + 1
                m = m - n
                If j = x(2).UpperBound(1) + 1 Then Exit Do
                n = x(2)(j, col3("Nilai").ColIndex)
            Else
                i = i + 1
                If i >= x(0).UpperBound(1) + 1 Then
                    i = i - 1
                    Exit Do
                End If
                n = n - m
    ...
    End If
    j = 0
    n = CDbl(x(1)(j, col2("Bayar").ColIndex))
    'Sisanya Kurangin Surat Jalan
    Do
        If n <= m Then  'Surat Jalan Lebih Kecil dari Pembayaran ke Surat Jalan Berikutnya
            TglPelunasan(j) = Tgl(i)
            If x(0)(i, col1("Cara Bayar").ColIndex) <> "GIRO" Then
                StatusLunas(j) = 1
                NoGiro(j) = ""
            Else
                StatusLunas(j) = 0
                NoGiro(j) = x(0)(TglIndex(i), col1("No Giro").ColIndex)
            End If
            j = j + 1
            m = m - n
            If j >= x(1).UpperBound(1) + 1 Then Exit Do
            n = x(1)(j, col2("Bayar").ColIndex)
        Else    'Surat Jalan Lebih Besar dari Pembayaran, Ke Pembayaran Berikutnya
            i = i + 1
            If i >= x(0).UpperBound(1) + 1 Then 'Pembayaran sudah Tidak ada, Anggap Lunas karena hanya selisih sedikit!!!
                Do While j <= x(1).UpperBound(1)
                    TglPelunasan(j) = Tgl(i - 1)
                    If x(0)(i - 1, col1("Cara Bayar").ColIndex) <> "GIRO" Then
                        StatusLunas(j) = 1
                        NoGiro(j) = ""
                    Else
                        StatusLunas(j) = 0
                        NoGiro(j) = x(0)(TglIndex(i - 1), col1("No Giro").ColIndex)
                    End If
                    j = j + 1
                Loop
                Exit Do
...
Dim nilaiRP As Double
    For i = 0 To x(0).UpperBound(1)
        If x(0)(i, col1("Cara Bayar").ColIndex) <> "" Then
            nilaiRP = IIf(fMataUang = "RP", x(0)(i, col1("Nilai").ColIndex), x(0)(i, col1("Nilai RP").ColIndex))
            ...
            If x(0)(i, col1("Cara Bayar").ColIndex) = "GIRO" Then
                ...
                End If
            End If
            a = "insert into t_PembelianSTTPembayaran(NoSTT,Tanggal,CaraBayar,NamaBank,NoGiro,TanggalGiro,Nilai,NilaiRP,DebetAcc, KetAcc, Keterangan,Status,NamaSupplier,MataUang) values('" & _
                fNoSTT & _
                "'," & cD(fTanggal) & _
                ",'" & x(0)(i, col1("Cara Bayar").ColIndex) & _
                "','" & x(0)(i, col1("Nama Bank").ColIndex) & _
                "','" & x(0)(i, col1("No Giro").ColIndex) & _
                "'," & IIf(cD(x(0)(i, col1("Tanggal Lunas").ColIndex)) = 0, cD(fTanggal), cD(x(0)(i, col1("Tanggal Lunas").ColIndex))) & _
    ...
    For i = 0 To x(1).UpperBound(1)
        If x(1)(i, col2("Bayar").ColIndex) <> "" And x(1)(i, col2("Bayar").ColIndex) <> "0" Then
            ...
            a = "insert into t_PembelianSTTPelunasan(NoSTT,Tanggal,NoFaktur,TanggalFaktur,NoRef,NamaSupplier, NilaiFaktur, Lunas, Sisa, Nilai, NilaiRP, Keterangan, MataUang, TanggalPelunasan) values('" & _
                fNoSTT & _
                "'," & cD(fTanggal) & _
                ",'" & x(1)(i, col2("No BTB").ColIndex) & _
                "'," & x(1)(i, col2("Tanggal").ColIndex) & _
                ",'" & x(1)(i, col2("No Ref").ColIndex) & _
                "','" & fSupplier & _
                "'," & cNum(x(1)(i, col2("Nilai Faktur").ColIndex)) & _
                "," & cNum(x(1)(i, col2("Lunas").ColIndex)) & _
                "," & cNum(x(1)(i, col2("Sisa").ColIndex)) & _
                "," & cNum(x(1)(i, col2("Bayar").ColIndex)) & _
                "," & cNum(BayarRP) & _
                ",'" & x(1)(i, col2("Keterangan").ColIndex) & _
                "','" & fMataUang & _
                "'," & TglPelunasan(i) & ")"
            If ExecMe(a) = 0 Then GoTo err
            a = "update t_BTB set NoGiro='" & NoGiro(i) & "',StatusLunas=" & StatusLunas(i) & ",NoSTT='" & fNoSTT & "', TanggalLunas=" & TglPelunasan(i) & ", Pelunasan=Pelunasan+" & cNum(x(1)(i, col2("Bayar").ColIndex)) & " where NoBTB='" & esc(x(1)(i, col2("No BTB").ColIndex)) & "'"
            ExecMe a
        End If
    Next
    TDBGrid3.Update
    ...
    For i = 0 To x(2).UpperBound(1)
        If x(2)(i, col3("No Bukti").ColIndex) <> "" Then
            ...
            a = "insert into t_PembelianSTTPotongan(NoSTT,Tanggal,NoBukti,TanggalBukti,NilaiRetur, Terpotong, Sisa, Nilai,NilaiRP,Keterangan, MataUang, NamaSupplier) values('" & _
                fNoSTT & _
                "'," & cD(fTanggal) & _
                ...
                "','" & fSupplier & "')"
            If ExecMe(a) = 0 Then GoTo err
            a = "update t_NRPembelian set Potong=Potong+" & cNum(x(2)(i, col3("Nilai").ColIndex)) & " where NoNR='" & x(2)(i, col3("No Bukti").ColIndex) & "'"
            If ExecMe(a) = 0 Then GoTo err
        End If
    Next
    a = "insert into t_PembelianSTT(NoSTT,Tanggal,Debet,Kredit,Pembulatan,NamaSupplier,GiroNum,MataUang) values('" & _
        fNoSTT & _
        "'," & cD(fTanggal) & _
        "," & cNum(fDebet.Tag) & _
        "," & cNum(fKredit.Tag) & _
...
'On Error GoTo err
    BeginTransaction
    For i = 0 To x(1).UpperBound(1)
        a = "update t_BTB set TanggalLunas=0,NoSTT=0, StatusLunas=0 , Pelunasan=Pelunasan-" & cNum(x(1)(i, col2("Bayar").ColIndex)) & " where NoBTB='" & esc(x(1)(i, col2("No BTB").ColIndex)) & "'"
        ExecMe a
    Next
    For i = 0 To x(2).UpperBound(1)
        a = "update t_NRPembelian set Potong=Potong-" & cNum(x(2)(i, col3("Nilai").ColIndex)) & " where NoNR='" & esc(x(2)(i, col3("No Bukti").ColIndex)) & "'"
        ExecMe a
    Next
    a = "delete from t_PembelianSTTPembayaran where NoSTT='" & esc(fNoSTT) & "'"
    ExecMe a
    a = "delete from t_PembelianSTTPelunasan where NoSTT='" & esc(fNoSTT) & "'"
    ExecMe a
    a = "delete from t_PembelianSTTPotongan where NoSTT='" & esc(fNoSTT) & "'"
    ExecMe a
    a = "delete from t_PembelianSTT where NoSTT='" & esc(fNoSTT) & "'"
    ExecMe a
    CommitTransaction
    MsgBox "SUKSES"
    GoEvent "NEW"
...
On Error Resume Next
    If CLng(x(2)(Bookmark, col3("Nilai").ColIndex)) = CLng(x(2)(Bookmark, col3("Sisa").ColIndex)) Then
        RowStyle.ForeColor = vbBlue
    End If
End Sub
